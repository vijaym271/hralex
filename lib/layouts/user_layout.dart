...
class _UserLayoutState extends State<UserLayout>
  ...
  static const List<Destination> allDestinations = <Destination>[
    ...
    Destination(1, 'Jobs', FontAwesomeIcons.suitcase, ColorUtils.black),
    Destination(2, 'Career', FontAwesomeIcons.graduationCap, ColorUtils.black),
    Destination(3, 'Podcast', FontAwesomeIcons.podcast, ColorUtils.black),
    Destination(4, 'More', FontAwesomeIcons.ellipsis, ColorUtils.black),
  ];
